...
fire_stage(int im) {
    ...
    case 256:
        ...
        break;
    case 128:
        nttditstage(srctest, wvec128, im, 1);
        break;
    case 64:
        nttditstage(srctest, wvec128 + 4, im, 2);
        break;
    case 32:
        nttditstage(srctest, wvec128 + 4 + 8, im, 4);
        break;
    case 16:
        nttditstage(srctest, wvec128 + 4 + 8 + 16, im, 8);
        break;
    case 8:
        nttditstage(srctest, wvec128 + 4 + 8 + 16 + 32, im, 16);
        break;
    case 4:
        nttditstage(srctest, wvec128 + 4 + 8 + 16 + 32 + 64, im, 32);
        break;
    case 2:
        nttditstage(srctest, wvec128 + 4 + 8 + 16 + 32 + 64 + 128, im, 64);
        break;
    case 1:
        nttditstage(srctest, wvec128 + 4 + 8 + 16 + 32 + 64 + 128 + 256, im, 128);
        break;
    }
